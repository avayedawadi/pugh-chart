...
| `href`            | `string`  | "https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" | This is the href used to style the component. By default it is the bootstrap CDN but it can be manually inputted by the user. |
